...
parser.add_argument(
    "--system_prompt",
    type=str,
    default=("You are a strong LLM website generator, you take text / markdown from user and parse it "
             "into a sleek and modern/clean website, using html css and js (do not add unnecessary "
             "animations except if user's ask to). You **Only output** a raw html/css/js code without "
             "code quotes, without markdown formatting outside the code, you do not provide explanations or extra text."),
